...
<header class="bg-white shadow">
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="flex w-full justify-between items-center">
            <h2 class="text-xl text-gray-400 leading-tight"> Consultas </h2>

            <div class="place-content-end flex gap-3"><a class="bg-emerald-700 hover:bg-emerald-600 text-white font-semibold px-4 py-2 rounded-md" href="/appointment/create">Cadastrar</a></div>
        </div>
    </div>
</header>
<main>
            ...
            <div class="flex flex-col">
                <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                    <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                        ...
                        <?php if (!empty($appointments) && is_array($appointments) || !empty($appointments) && is_object($appointments)) : ?>
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-gray-50">
                                        <tr>
                                            ...
                                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"> Dentista </th>
                                        ...
                                        <?php foreach ($appointments as $appointment) : ?>
                                            <tr>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm font-medium text-gray-900"><?php echo $appointment->client_id; ?></div>
                                                </td>
