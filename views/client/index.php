...
<header class="bg-white shadow">
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div class="flex w-full justify-between items-center">
            <h2 class="text-xl text-gray-400 leading-tight"> Clientes </h2>

            <div class="place-content-end flex gap-3"><a class="bg-emerald-700 hover:bg-emerald-600 text-white font-semibold px-4 py-2 rounded-md" href="/client/create">Cadastrar</a></div>
        </div>
    </div>
</header>
<main>
                                        ...
                                        <?php foreach ($clients as $client) : ?>
                                            <tr>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm font-medium text-gray-900"><?php echo $client->name; ?></div>
                                                </td>

                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm font-medium text-gray-900"><?php echo $client->email; ?></div>
                                                </td>

                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="text-sm font-medium text-gray-900"><?php echo $client->cpf; ?></div>
                                                </td>
